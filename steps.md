...
1. git clone https://github.com/sparkrew/coolname
2. cd coolname
3. mvn clean install
...
For example,
```bash
python3 /Users/yogyagamage/Documents/UdeM/Courses/Testing/project/coolname/api-finder/feedback_score.py --project-dir /Users/yogyagamage/Documents/UdeM/Courses/Testing/project/eval/pdfbox/pdfbox  \
